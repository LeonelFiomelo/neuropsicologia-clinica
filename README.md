# Neuropsicología Clínica – Sitio Web

Sitio web institucional desarrollado con **Next.js**, **TypeScript** y **Tailwind CSS** para la Carrera Interdisciplinaria de Especialización en Neuropsicología Clínica.
El objetivo es ofrecer una plataforma clara y moderna donde se presente la información académica, el plan de estudios, el cuerpo docente y las vías de contacto para los interesados.
...
```bash
git clone https://github.com/LeonelFiomelo/neuropsicologia-clinica.git
cd neuropsicologia-clinica
npm install
```
